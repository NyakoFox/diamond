    ...
    return (
        <div className="container mx-auto p-4 flex flex-col align-middle justify-items-center w-full">
            ...
            <div className="ml-16 mr-16 grid grid-cols-3 gap-16 mb-16">
                <ProjectCard className="bg-[url('/project_cards/kristal.gif')] bg-cover bg-center" title="Kristal" description="A DELTARUNE fangame engine written in LÖVE." link="https://kristal.cc/" outside />
                <ProjectCard title="Diamond" description="This website, written in React." link="https://github.com/NyakoFox/diamond" outside />
                <ProjectCard className="bg-[url('/project_cards/allymoe.jpg')] bg-cover bg-center bg-blend-multiply" title="ally.moe" description="My old website." link="https://ally.moe/" outside />
            ...
            <div className="ml-16 mr-16 grid grid-cols-3 gap-16 mb-16">
                <ProjectCard className="bg-[url('/project_cards/vvvvvv.jpg')] bg-cover bg-center bg-blend-multiply" title="VVVVVV" description="A retro-styled platformer game where you flip gravity." link="https://github.com/TerryCavanagh/VVVVVV/commits?author=AllyTally" outside />
