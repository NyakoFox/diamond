export const meta = {
  title: 'Doesn\'t everyone have one of these? (Initial test post)',
...
## It's sorta that easy

Forgot the second argument of `useEffect` -- it was supposed to be an empty array. That's working now.
...
Turns out if you put the array in the wrong place, it doesn't work.
...
using Tailwind, etc. It's definitely a lot to take in, and while I didn't *have* to use MDX or Tailwind, I wanted to.

### I'm sure I'll get the hang of it eventually however.